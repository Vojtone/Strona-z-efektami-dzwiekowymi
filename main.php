<?php
    ...
    {
        header('Location: main.php?category=wszystkie&sort_by=najnowsze');
        exit();
    }

    if (!isset($_GET['page']))
    {
        header('Location: main.php?category='.$_GET['category'].'&sort_by='.$_GET['sort_by'].'&page=1');
        exit();
    }
?>
        ...
        <div id=content>
                        ...
                        else
                        {
                            ...
                            for ($i=0; $i<$how_many_rows; $i++)
                            {
                                ...
                                if ( $i>=(($_GET['page']-1)*$how_many_sounds_on_page) && ($i<$_GET['page']*10) && ($i<$how_many_rows) ) //wyswietlanie wybranych do page
                                {
                                    ...
                                    echo 'Dodał: <a href="user.php?user='.$owner_name.'"><div class="user_id_sound" style="display: inline-block;">'.$owner_name.'</div></a> ';
                            ...
                            if ($_GET['page'] > 1)
                            {
                                ...
                                echo '<a href="main.php?category='.$_GET['category'].'&sort_by='.$_GET['sort_by'].'&page='.$previous.'" ><div class="page"><<</div></a>';
                            }
                            ...
                            for ($i = $page-2; $i <= $page+2 ; $i++)
                            {
                                if ($i>0 && $i<=round($how_many_pages+0.49))
                                {
                                    if ($_GET['page'] == $i)
                                    {
                                        echo '<a href="main.php?category='.$_GET['category'].'&sort_by='.$_GET['sort_by'].'&page='.$i.'" ><div class="page" style="color: #ff6d0b;">'.$i.'</div></a>';
                                    }
                                    else
                                    {
                                        echo '<a href="main.php?category='.$_GET['category'].'&sort_by='.$_GET['sort_by'].'&page='.$i.'" ><div class="page">'.$i.'</div></a>';
                                    }
                                }
                            }
                            ...
                            {
                                $next = $_GET['page'] + 1;
                                echo '<a href="main.php?category='.$_GET['category'].'&sort_by='.$_GET['sort_by'].'&page='.$next.'" ><div class="page">>></div></a>';
                            }
            ...
            <div id="content_list">
                ...
                <ol style="margin-top: 20px;">
                    <?php
                        echo
                        '<a href="main.php?category=wszystkie&sort_by='.$_GET['sort_by'].'" ><li>Wszystkie</li></a>
                        <a href="main.php?category=natura&sort_by='.$_GET['sort_by'].'" ><li>Natura</li></a>
                        <a href="main.php?category=akcja&sort_by='.$_GET['sort_by'].'" ><li>Akcja</li></a>
                        <a href="main.php?category=obyczajowe&sort_by='.$_GET['sort_by'].'" ><li>Obyczajowe</li></a>
                        <a href="main.php?category=inne&sort_by='.$_GET['sort_by'].'" ><li>Inne</li></a>';
                    ?>
				</ol>
                </div>
                ...
                <ol style="margin-top: 20px;">
                    <?php
                        echo
                        '<a href="main.php?category='.$_GET['category'].'&sort_by=najnowsze" ><li>Najnowsze</li></a>
                        <a href="main.php?category='.$_GET['category'].'&sort_by=najstarsze" ><li>Najstarsze</li></a>
                        <a href="main.php?category='.$_GET['category'].'&sort_by=najwiecej_pobran" ><li>Najwięcej pobrań</li></a>
                        <a href="main.php?category='.$_GET['category'].'&sort_by=najlepsza_ocena" ><li>Najlepsza ocena</li></a>
                        <a href="main.php?category='.$_GET['category'].'&sort_by=najwiecej_ocen" ><li>Najwięcej ocen</li></a>';
                    ?>
                </ol>
                </div>
            </div>
